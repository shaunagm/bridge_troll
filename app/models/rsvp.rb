class Rsvp < ActiveRecord::Base
  PERMITTED_ATTRIBUTES = [:subject_experience, :teaching, :taing, :teaching_experience, :teaching_experience, :childcare_info, :operating_system_id, :job_details, :class_level, :dietary_info, :needs_childcare, :plus_one_host, :preevent_contact, :potential_projects, :availability, :availability_info, :volunteer_projects, :volunteer_training, :activity_intro, :activity_tools, :activity_git, :activity_panel, :activity_workshop]
